...
COOKIE_NAME = 'weibosession'
_COOKIE_KEY = configs.session.secret


def user2cookie(user, max_age):
    '''
    Generate cookie str for user
    :param user:
    :param max_age:
    :return:
    '''
...
def index(request):
    ...
    # #users = {'id':1234, 'name':'test', 'mail':'sdfsd@asf.com', 'passwd':'passwd'}
    # return {
...
def authenticate(*, email, passwd):
    ...
    sha1.update(
        b':')  # Bytes literals are always prefixed with 'b' or 'B'; they produce an instance of the bytes type instead of the str type.
